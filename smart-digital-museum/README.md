...
- **🏷️ Category & Period Filtering**: Filter collections by category (_Ancient Artifacts_, _Famous Artworks_, _Great Inventions_, _Cultural Heritage_) and historical period (_Ancient_, _Renaissance_, _Medieval_, _Industrial_).
...
- **📊 Multi-criteria Sorting**: Sort artifacts by creation year (_Oldest_, _Newest_) or alphabetically (_Name A-Z_).
- **🏛️ Virtual Museum Rooms**: Directly enter interactive virtual rooms (_Ancient World_, _Art Gallery_, _Inventions_, _Cultural Heritage_) with auto-scrolling room navigation.
