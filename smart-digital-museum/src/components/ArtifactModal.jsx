    ...
    return (
        <div id="artifact-modal" className="modal active fixed inset-0 bg-black/80 backdrop-blur-sm z-[1000] flex justify-center items-center p-4 overflow-y-auto" onClick={onClose}>
            <div className="modal-content relative bg-white dark:bg-neutral-800 text-neutral-900 dark:text-neutral-100 p-6 md:p-8 rounded-2xl w-full max-w-2xl max-h-[90vh] overflow-y-auto shadow-2xl border border-neutral-200 dark:border-neutral-700" onClick={(e) => e.stopPropagation()}>
                ...
                <div id="modal-content" className="space-y-3">
                    <img
                        src={artifact.image}
                        alt={artifact.name}
                        onError={handleImageError}
                        className="w-full h-64 md:h-72 object-cover rounded-xl mb-5 shadow-md"
                    />
                    ...
                    <p className="text-sm md:text-base text-neutral-700 dark:text-neutral-300"><strong className="text-neutral-900 dark:text-neutral-100">Year:</strong> {formattedYear}</p>
                    <p className="text-sm md:text-base text-neutral-700 dark:text-neutral-300"><strong className="text-neutral-900 dark:text-neutral-100">Creator / Dynasty:</strong> {artifact.creator}</p>
